        ...
        <div className="flex justify-center items-center h-full  ">
          <div className="w-[50%] space-y-6">
            ...
            <p className="text-gray-500 text-sm">
              Algo deu errado. Parece que sua solicitação não foi encontrada.
              Parece que o link está quebrado ou a página foi removida.
            </p>

            <div className="flex mt-4 justify-between items-center text-gray-500">
              <button className="text-white text-sm bg-laranja p-2 rounded-lg text-center px-10">
