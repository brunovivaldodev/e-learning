...
export function PaymentCard({ courseId }: Props) {
  ...
  async function handleRegister(event: FormEvent<HTMLFormElement>) {
    ...
    router.replace(`/courses/watch/${courseId}`);
  }

  return (
    <>
      <Button
        className="p-2 bg-peach text-sm text-[#FF6636] w-full"
        onPress={onOpen}
      >
        Comprar Agora
      </Button>
        ...
        <ModalContent>
          <ModalBody>
            ...
            >
              ...
              <button
                type="submit"
                className="p-2 text-center bg-peach text-sm text-[#FF6636] w-full mb-6"
              >
                Comprar
              </button>
            </form>
